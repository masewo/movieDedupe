...
class Event(object):
    ...
    def readCodepage(self, data, ofs):
        ...
        try:
            ...
            byte1 = ''
        if byte1 == "1":
            self.codepage = 'iso-8859-5'
        elif byte1 == "2":
            self.codepage = 'iso-8859-6'
        elif byte1 == "3":
            self.codepage = 'iso-8859-7'
        elif byte1 == "4":
            self.codepage = 'iso-8859-8'
        elif byte1 == "5":
            self.codepage = 'iso-8859-9'
        elif byte1 == "6":
            self.codepage = 'iso-8859-10'
        elif byte1 == "7":
            self.codepage = 'iso-8859-11'
        elif byte1 == "9":
            self.codepage = 'iso-8859-13'
        elif byte1 == "10":
            self.codepage = 'iso-8859-14'
        elif byte1 == "11":
        ...
        if path and os.path.exists(path):
            ...
            if self.eit_mtime == mtime:
                ...
                if data and 12 <= len(data):
                    ...
                    if description:
                        description = re.sub(
                            '((?:Moderat(?:ion:|or(?:in){0,1})|Vorsitz: |Jur(?:isten|y): |G(?:\xC3\xA4|a)st(?:e){0,1}: |Mit (?:Staatsanwalt|Richter(?:in){0,1}|den Schadenregulierern) |Julia Leisch).*?[a-z]+)(\'{0,1}[0-9A-Z\'])',
                            r'\1\n\n\2', description)
